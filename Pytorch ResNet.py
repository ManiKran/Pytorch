...
Original file is located at
    https://colab.research.google.com/drive/1yVIzc6L_t2rBFvV70xu8c9ai2ogmMnCh
"""
...
def ResNet101(img_chnnels=3, num_classes=1000):
  return ResNet(block, [3,4,23,3], img_channels, num_classes)

def ResNet152(img_chnnels=3, num_classes=1000):
